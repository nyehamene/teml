...
var invalid = []string{
	...
	"(document [] (div {a:})) ;desc: missing attribute value",
	"(document [] (div {a: foo})) ;desc: invalid expression",
	...
	"(component F [] (div {a:})) ;desc: missing attribute value",
	"(component F [] (div {a: foo})) ;desc: invalid expression",
